...
Parameter('time_delay_k', 0.2)
Parameter('activate_p53_k', 5000)             # per hour
Parameter('transcribe_Puma_k', 0.001)
Parameter('transcribe_BIM_k', 0.001)
Parameter('transcribe_Bid_k', 0.001)
Parameter('transcribe_Bax_k', 0.001)
Parameter('transcribe_Bak_k', 0.001)
...
Observable('Obs_Bax', Bax())
Observable('Obs_Bak', Bak())
...
# Observable('Obs_signal_factor', Expression('signal_factor', Obs_signal4 ** n / (Obs_signal4 ** n + T ** n)))
...
Expression('signal4_exp', (max_signal*frequency1/10*3.14159)*sin(frequency1*np.pi*Obs_time))
Expression('signal5_exp', (max_signal*frequency2/10*3.14159)*sin(frequency2*np.pi*Obs_time))
Expression('signal6_exp', (max_signal*frequency3/10*3.14159)*sin(frequency3*np.pi*Obs_time))
Expression('signal7_exp', (max_signal*1.3863) * np.e**(-1.3863*Obs_time))
...
# pl.plot(simulation_time, yout['signal_factor'], label='signal_factor')
# pl.plot(simulation_time, yout['Obs_time_delay'], label='time delay')
# pl.plot(simulation_time, yout['Obs_time'], label='time')
pl.legend(loc='best')
pl.xlabel('Time (h)')
